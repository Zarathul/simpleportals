...
public class Recipe {
	 ...
	 * 
	 * @return The recipes components in an string array or <code>null</code> if
	 *         this recipe has no components.
	 */
	 ...
	 * 
	 * @return The generated arguments or <code>null</code> if a component of the
	 *         recipe could't be found or if an component identifier is missing.
	 */
	public Object[] getRegistrationArgs() {
		...
		for (RecipeComponent component : components) {
			...
			if (!isShapeless) {
				...
				if (id == RecipeComponent.EMPTY_IDENTIFIER.charAt(0))
					return null;
	 ...
	 * @return The generated recipe components or <code>null</code> if the string
	 *         array is <code>null</code>, has an invalid length or contains
