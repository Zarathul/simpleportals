...
public class Portal implements INBTSerializable<NBTTagCompound> {
	...
	public Portal(int dimension, Address address, Axis axis, Corner corner1, Corner corner2, Corner corner3,
			Corner corner4) {
	 ...
	 * 
	 * @return An <code>int</code> representing the dimension id.
	 */
	...
	public Iterable<BlockPos> getFramePositions(boolean includeCorners) {
		...
		BlockPos.getAllInBox(corner1.getPos().offset(dir1To2), corner2.getPos().offset(dir1To2.getOpposite()))
				.forEach(e -> frame.add(e));
		BlockPos.getAllInBox(corner1.getPos().offset(dir1To3), corner3.getPos().offset(dir1To3.getOpposite()))
				.forEach(e -> frame.add(e));
		BlockPos.getAllInBox(corner4.getPos().offset(dir4To2), corner2.getPos().offset(dir4To2.getOpposite()))
				.forEach(e -> frame.add(e));
		BlockPos.getAllInBox(corner4.getPos().offset(dir4To3), corner3.getPos().offset(dir4To3.getOpposite()))
				.forEach(e -> frame.add(e));
	...
	public boolean hasAddressChanged(World world) {
		...
		Address actualAddress = new Address(PortalRegistry.getAddressBlockId(world.getBlockState(corner1.getPos())),
