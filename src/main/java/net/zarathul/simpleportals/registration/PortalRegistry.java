...
public final class PortalRegistry {
	 ...
	 * @param side
	 *            The {@link EnumFacing} representing the side of the portal frame
	...
	public static boolean activatePortal(World world, BlockPos pos, EnumFacing side) {
		...
		if (getDistance(corner1.getPos(), corner2.getPos()) > Config.maxSize
				|| getDistance(corner1.getPos(), corner3.getPos()) > Config.maxSize)
			return false;
		...
		Address address = new Address(getAddressBlockId(addBlock1), getAddressBlockId(addBlock2),
				getAddressBlockId(addBlock3), getAddressBlockId(addBlock4));
		...
		for (BlockPos portalPos : portalPositions) {
			world.setBlockState(portalPos,
					SimplePortals.blockPortal.getDefaultState().withProperty(BlockPortal.AXIS, portalAxis));
		}
	 ...
	 *            The {@link World} the portal is located in.
	 * @param pos
	 *            The {@link BlockPos} of one of the portals blocks (portal or
	 *            frame).
	 */
	 ...
	 * @return A read-only list of found portals (may be empty) or <code>null</code>
	 *         if <code>address</code> was <code>null</code>.
	 */
	 ...
	 * @return A read-only list of {@link BlockPos} (may be empty) or
	 *         <code>null</code> if <code>portal</code> was <code>null</code>.
	 */
	 ...
	 * @return <code>true</code> if the amount could be removed, otherwise
	 *         <code>false</code>.
	 */
	 ...
	 * @return A string of the format "registryName#meta" or <code>null</code> if
	 *         <code>blockState</code> is <code>null</code>.
	 */
	 ...
	 * @return <code>true</code> if the block is a portal frame, otherwise
	 *         <code>false</code>.
	 */
	...
	private static boolean isValidAddressBlock(IBlockState state) {
		if (state == null || state.getBlock().hasTileEntity(state) || !state.getBlock().isFullBlock(state))
			return false;
	...
	public static void readFromNBT(NBTTagCompound nbt) {
		...
		if (portalsTag == null || portalBlocksTag == null || powerTag == null)
			return;
